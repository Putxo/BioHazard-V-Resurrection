...
namespace {
const FUN_004065A0_Services* g_services = nullptr;
...
constexpr const char* k_archive_name = "Image\\Archive\\Title2Resource";
constexpr std::uintptr_t k_direct_table = 0x015677C8U;
...
void FUN_004065A0_SetServices(const FUN_004065A0_Services* services) noexcept {
    g_services = services;
}

void FUN_004065A0() noexcept {
