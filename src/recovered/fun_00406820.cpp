...
namespace {
const FUN_00406820_Services* g_services = nullptr;

constexpr std::int32_t k_message_index = -1;
constexpr const char* k_archive_name = "Image\\Archive\\Credit2Resource";
constexpr std::uintptr_t k_direct_table = 0x01567C08U;
