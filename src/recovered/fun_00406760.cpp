...
namespace {
const FUN_00406760_Services* g_services = nullptr;

constexpr std::int32_t k_message_index = -1;
constexpr const char* k_archive_name = "Image\\Archive\\Extra2End";
constexpr std::uintptr_t k_direct_table = 0x01567B20U;
...
void FUN_00406760_SetServices(const FUN_00406760_Services* services) noexcept {
    g_services = services;
}

void FUN_00406760() noexcept {
